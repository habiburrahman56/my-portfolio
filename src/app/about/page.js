...
export default function About() {
  return (
    <main className="bg-black text-white min-h-screen overflow-x-hidden">
      ...
      <section className="max-w-4xl mx-auto py-20 px-6 flex flex-col justify-center items-center text-center">
        {/* My Image */}
        <img
          src="/my-image.png"
          alt="My Avatar"
        ...
        <Link href="/contact">
          <button className="mt-8 inline-block px-8 py-4 bg-green-400 hover:bg-green-500 transition text-black rounded-lg font-semibold capitalize">
            contact me
          </button>
        </Link>
      </section>
